    ...
    return (
        <>
            ...
            <input
                ...
                onChange={onChange}
            />
            <button disabled={!value} onClick={onSubmit} className="block w-full bg-blue-500 hover:bg-blue-600 duration-200 text-white font-medium rounded-md p-2 mb-2">{nameClick}</button>
